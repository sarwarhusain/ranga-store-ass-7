...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <span class='star-rate'>Rating: ${product.rating.rate}</span>
      <span class="star-rating"><i class="fas fa-star"></i></span>
      <span class="star-rating"><i class="fas fa-star"></i></span>
      <span class="star-rating"><i class="fas fa-star"></i></span>
      <span class="star-rating"><i class="fas fa-star-half-alt"></i></i></span>
      <span><i class="far fa-star"></i></span>
      <span class="count">Count: ${product.rating.count}</span>
      ...
      <button id="details-btn" class="btn btn-warning font-white fw-bold">Details</button></div>
      `;
